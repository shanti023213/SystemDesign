package com.systemDesign.numberNotAvailableinFile;

import java.io.FileNotFoundException;
import java.io.FileReader;
import java.util.Scanner;

public class FindNumberFollowUp {
	...
	public static void findOpenNumber() throws FileNotFoundException {
		int starting = -1;
		Scanner in = new Scanner (new FileReader ("/Users/udayaseetha/Documents/interviews/DataStructures/SystemDesign/src/com/systemDesign/numberNotAvailableinFile/input.txt"));
		while (in.hasNextInt()) {
		    int n = in.nextInt();
		...
		in = new Scanner(new FileReader("/Users/udayaseetha/Documents/interviews/DataStructures/SystemDesign/src/com/systemDesign/numberNotAvailableinFile/input.txt"));
		while (in.hasNextInt()) {
			int n = in.nextInt();
